...
import pandas as pd
from st_aggrid import AgGrid, GridOptionsBuilder, GridUpdateMode, ColumnsAutoSizeMode, JsCode, DataReturnMode
...
if st.session_state["menu_area"] == "FISCAL":
    paginas_disponiveis = ["EMPRESAS", "SIMPLES NACIONAL", "REINF", "DCTF WEB",
                           ...
                           "SEFAZ ALTERAÇÃO QUANTIDADE NOTAS", "CLIENTES/FORNEC CNPJ"]
...
def _carrega_situacao_fiscal():
    ...
    if "CNPJ" in df_merge.columns:
        df_merge["CNPJ"] = df_merge["CNPJ"].apply(_formata_cnpj)
...
# COMPARTILHADO entre todos os escritórios desde 30/08/2026 (ver
# apps_script_pdf_situacao_fiscal.gs) - o parâmetro ?escritorio=asbem no final
# da URL diz pro script qual pasta do Drive ler; a URL em si é a MESMA pra
# todo mundo, só o parâmetro muda por escritório.
APPS_SCRIPT_PDF_SITUACAO_FISCAL_URL = "https://script.google.com/macros/s/AKfycbz7FnVmU0-39_HszitoisrnNZ60fNpVVSXH55m3ufxoPmWEzj5uEy6Gsx9G87WiesXi/exec?escritorio=asbem"
